...
Here is the screenshot for the overview of  functionality of the page: ![]()

This website is aiming to read the file from the local storage and and update a latest message to the platform.